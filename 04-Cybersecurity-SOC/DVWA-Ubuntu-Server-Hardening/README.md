...
Screenshots should be added to the repository under an `assets` or `screenshots` folder.

Recommended screenshots to include:

- Ubuntu server hostname and IP address
- UFW firewall status
...
- Listening ports before and after hardening
- Kali or Windows connectivity testing
- tcpdump or Wireshark packet capture evidence
...
![Fail2Ban SSH Jail](screenshots/fail2ban-sshd-status.png)

![Lynis Audit Summary](screenshots/lynis-summary.png)
```
...
Recommended files for this project folder:
